 ...
 * It is noteworthy that substrings are also  similar  to subArray  becuase it is a chunk of strings.
 * And it is exactly the same way to check for a substring as to check for a subarray 'abeaded'
 * 
 * Question? What you are writting here is conflicting the top part. Can we have only part of an array or all the array?
 * you can't skip numbers. eg.
 * [4,7] is not a valid sub array of [4,5,7] as you skipped 5. But  [4, 5] is valid also [4, 7] is also valid
 * 
